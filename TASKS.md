...
- [ ] Meta Pixel — להזין את המזהה האמיתי ב-`SITE_CONFIG.fbPixelId` כשיתקבל מהמשתמש (התשתית מוכנה: הסכמת שיווק v2, PageView לכל ניווט, Lead בקליטת טופס, Contact בלחיצות קשר, ModalOpen)
